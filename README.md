...
| [`apps_lic_v2`](apps_lic_v2/) | Standalone Lifecycle Intelligence & Communication — grounded outbound authoring & multi-touch sequence engine | [→](apps_lic_v2/README.md) | - | - | - | - |
...
> [!NOTE]
> **Monolith Retirement**: Legacy `agentic_core`, `apps_shared`, `apps_rg`, and `apps_lic` have been permanently retired. The active portfolio is powered by standalone, decoupled autonomous v2 subsystems ([`apps_rg_v2`](apps_rg_v2/), [`apps_lic_v2`](apps_lic_v2/)) with zero monolithic framework dependencies.
