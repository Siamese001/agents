> [!NOTE]
> **Archival Provenance Notice**: This plan documents the initial source freeze and standalone repository creation executed in July-August 2026. This plan is historical and has been fully completed and superseded by `apps_rg_v2`.
...
PLAN_STATUS: COMPLETED_AND_SUPERSEDED_BY_APPS_RG_V2
CURRENT_WAVE: S2
BLOCKED_WAVE: NONE
