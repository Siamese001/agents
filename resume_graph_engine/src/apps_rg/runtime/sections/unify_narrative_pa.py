...
def _legacy_i0(runtime_payload: dict[str, Any]) -> str:
    ...
    return (
        ...
        "MECHANISM LAW — narrative must name at least one concrete mechanism/technology token from "
        "the role's finalized bullets (e.g. agentic, runtime, pipeline, orchestration, telemetry, lakehouse, Databricks). "
        "Ground the role thesis in at least one named platform mechanism rather than purely abstract consulting terminology.\n\n"
