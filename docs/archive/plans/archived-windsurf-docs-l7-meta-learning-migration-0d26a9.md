...
original_path: 'C:\\Git\\windsurf-plans-recovered\\docs_reports_plans\\l7-meta-learning-migration-0d26a9.md'
original_relative_path: 'l7-meta-learning-migration-0d26a9.md'
source_sha256: 07dc967338e51fb54e0625e728bc6827ac9772312256295a9a3989b5f8857919
...
---
# L7 Meta-Learning Migration Plan
...
## Summary
Move `agentic_core/L7_meta_learning` to `system_learning/` with comprehensive import updates and test migration.
...
### Dependencies Found
- **Direct imports**: 23 files import from `agentic_core.L7_meta_learning`
- **Key consumers**:
  - `agentic_core.L0_routing.meta_control.*` (4 files)
  - `apps_shared.scripts.*` (2 files)
  - `agentic_core.L5_safety.config.structure_blueprint._constants` (1 file)
  - Test files (9 files)
...
### Phase 3: Import Updates (23 files)
