...
original_path: 'C:\\Git\\windsurf-plans-recovered\\docs_reports_plans\\phase_05_06_consolidated.md'
original_relative_path: 'phase_05_06_consolidated.md'
source_sha256: 34bdd1d3907c61a46caaf4ac23e2098cda1f601fb99a4dd5841613e536823473
...
---
# Phases 5-6: Spine Adapter Normalization & Structural Enforcement (Consolidated)
...
## CODE_COMMIT
e318da0f05b5f7344b0f65d4e6a7c7413e32de6b
...
```
$ C:\Users\amita\AppData\Local\Programs\Python\Python312\python.exe -m pytest -q tests/unit_min_deps/test_spine_cross_app_contract.py
[1m============================= test session starts =============================[0m
platform win32 -- Python 3.12.10, pytest-9.0.2, pluggy-1.6.0
rootdir: C:\Git\Agentic-Workflow
configfile: pytest.ini (WARNING: ignoring pytest config in pyproject.toml!)
...
tests/unit_min_deps/test_spine_cross_app_contract.py::test_cross_app_cid_prefixes [32mPASSED[0m[32m [ 20%][0m
tests/unit_min_deps/test_spine_cross_app_contract.py::test_cross_app_cid_hash_bodies_identical [32mPASSED[0m[32m [ 40%][0m
tests/unit_min_deps/test_spine_cross_app_contract.py::test_cross_app_cid_determinism [32mPASSED[0m[32m [ 60%][0m
tests/unit_min_deps/test_spine_cross_app_contract.py::test_cross_app_cid_difference [32mPASSED[0m[32m [ 80%][0m
tests/unit_min_deps/test_spine_cross_app_contract.py::test_cross_app_call_order_invariant [32mPASSED[0m[32m [100%][0m
...
```
$ C:\Users\amita\AppData\Local\Programs\Python\Python312\python.exe ops_scripts/ci/check_spine_adapter_contract.py
Checking 2 spine adapter file(s)...
STDERR: Traceback (most recent call last):
  File "C:\Git\Agentic-Workflow\ops_scripts\ci\check_spine_adapter_contract.py", line 197, in <module>
    sys.exit(main())
             ^^^^^^
  File "C:\Git\Agentic-Workflow\ops_scripts\ci\check_spine_adapter_contract.py", line 186, in main
...
[1m-------------------------------- live log call --------------------------------[0m
2026-02-22 15:42:35 [[32m    INFO[0m] agentic_core.L5_safety.reasoning.InspectorExecutor: [InspectorExecutor] Inspector
...
[1m-------------------------------- live log call --------------------------------[0m
2026-02-22 15:42:55 [[1m[31m   ERROR[0m] agentic_core.L2_execution.audit.hash_chain_audit_log: [audit] hash mismatch at entry 1
...
[1m-------------------------------- live log call --------------------------------[0m
2026-02-22 15:42:55 [[33m WARNING[0m] agentic_core.utils.decorators_util: [standard_heal] MockAgent: Non-canonical key '_policy_from_kwargs' detected. Consider using canonical keys for better schema compliance.
...
2.73s call     tests/governance/test_seam_dynamic_enforcement.py::TestSeamDynamicEnforcement::test_scan_produces_deterministic_results
...
2.09s call     tests/governance/test_upward_import_enforcement.py::TestUpwardImportEnforcement::test_scan_produces_deterministic_results
1.53s call     tests/governance/test_agent_heal_audit.py::TestMarkdownGeneration::test_markdown_generation
1.51s call     tests/governance/test_agent_heal_audit.py::TestStructureContract::test_top_level_schema
1.51s call     tests/governance/test_heal_surface_enforcement.py::TestHealSurfaceEnforcement::test_all_agents_have_heal_surface
1.51s call     tests/governance/test_agent_heal_audit.py::TestStructureContract::test_result_item_schema
[33m================= [32m1165 passed[0m, [33m[1m4 warnings[0m[33m in 63.35s (0:01:03)[0m[33m =================[0m
```
