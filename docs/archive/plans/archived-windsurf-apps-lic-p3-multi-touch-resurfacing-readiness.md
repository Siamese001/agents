...
source_key: windsurf
original_path: 'C:\\Git\\windsurf-plans-recovered\\windsurf_plans\\apps-lic-p3-multi-touch-resurfacing-readiness.md'
original_relative_path: 'apps-lic-p3-multi-touch-resurfacing-readiness.md'
