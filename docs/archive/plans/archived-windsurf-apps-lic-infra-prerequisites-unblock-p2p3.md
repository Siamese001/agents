...
source_key: windsurf
original_path: 'C:\\Git\\windsurf-plans-recovered\\windsurf_plans\\apps-lic-infra-prerequisites-unblock-p2p3.md'
original_relative_path: 'apps-lic-infra-prerequisites-unblock-p2p3.md'
