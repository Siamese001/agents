...
source_key: claude
original_path: 'C:\\Git\\Agentic-Workflow-FRESH\\.codex\\plans\\_archive\\historical_plans_20260515_cursor_optimization\\apps-rg-spine-hardening-deferred-d4e7a3.md'
original_relative_path: '_archive\\historical_plans_20260515_cursor_optimization\\apps-rg-spine-hardening-deferred-d4e7a3.md'
source_sha256: d82bb4cdc2c5b2ac19b339029bf512ce75348bd0f223c4b0a0695b42f46f9085
...
```
PLAN_CREATED: slug=apps-rg-spine-hardening-deferred-d4e7a3 path=.windsurf/plans/apps-rg-spine-hardening-deferred-d4e7a3.md tier=T3 status=Not Started waves=index-only
```
