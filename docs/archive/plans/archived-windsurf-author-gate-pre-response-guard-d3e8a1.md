...
source_key: windsurf
original_path: 'C:\\Git\\windsurf-plans-recovered\\windsurf_plans\\author-gate-pre-response-guard-d3e8a1.md'
original_relative_path: 'author-gate-pre-response-guard-d3e8a1.md'
