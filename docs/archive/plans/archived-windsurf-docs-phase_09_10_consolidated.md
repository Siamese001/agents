...
original_path: 'C:\\Git\\windsurf-plans-recovered\\docs_reports_plans\\phase_09_10_consolidated.md'
original_relative_path: 'phase_09_10_consolidated.md'
source_sha256: dc8c91814cfdd55a17d44987ec2a6cab3cc3568adcb127d82bce381e9a72bb09
...
---
# Phases 9-10: Evidence Contract v2 Rollout + CI Enforcement (Consolidated)
...
## CODE_COMMIT
dbc4fce20f6cdcbad0fbba2d887ca0432f11f12e

## EVIDENCE_COMMIT
44f7afee9ed699a8f046c42e9bd45bbba79a0252
...
[1m-------------------------------- live log call --------------------------------[0m
2026-02-22 17:24:58 [[32m    INFO[0m] agentic_core.L5_safety.reasoning.InspectorExecutor: [InspectorExecutor] Inspector
...
[1m-------------------------------- live log call --------------------------------[0m
2026-02-22 17:25:18 [[1m[31m   ERROR[0m] agentic_core.L2_execution.audit.hash_chain_audit_log: [audit] hash mismatch at entry 1
...
[1m-------------------------------- live log call --------------------------------[0m
2026-02-22 17:25:18 [[33m WARNING[0m] agentic_core.utils.decorators_util: [standard_heal] MockAgent: Non-canonical key '_policy_from_kwargs' detected. Consider using canonical keys for better schema compliance.
...
2.97s call     tests/governance/test_agent_heal_audit.py::TestDeterminism::test_byte_identical_json_runs
2.96s call     tests/governance/test_seam_dynamic_enforcement.py::TestSeamDynamicEnforcement::test_scan_produces_deterministic_results
2.87s call     tests/governance/test_upward_import_enforcement.py::TestLazySeamMetric::test_lazy_upward_import_metric_is_deterministic
2.42s call     tests/governance/test_upward_import_enforcement.py::TestUpwardImportEnforcement::test_scan_produces_deterministic_results
1.54s call     tests/governance/test_seam_dynamic_enforcement.py::TestSeamDynamicEnforcement::test_dynamic_violation_summary
...
1.51s call     tests/governance/test_agent_heal_audit.py::TestEnumerationIntegrity::test_base_class_name_extraction
[33m================= [32m1165 passed[0m, [33m[1m4 warnings[0m[33m in 67.77s (0:01:07)[0m[33m =================[0m
```
