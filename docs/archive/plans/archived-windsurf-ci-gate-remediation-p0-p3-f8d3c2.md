...
source_key: windsurf
original_path: 'C:\\Git\\windsurf-plans-recovered\\windsurf_plans\\ci-gate-remediation-p0-p3-f8d3c2.md'
original_relative_path: 'ci-gate-remediation-p0-p3-f8d3c2.md'
